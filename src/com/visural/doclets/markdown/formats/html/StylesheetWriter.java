...
import com.visural.doclets.markdown.internal.toolkit.util.*;
...
public class StylesheetWriter extends HtmlDocletWriter {
    ...
    protected void generateStyleFile() {
        ...
        println("body { font-family: "+fontFamily+"; font-size: 10pt; background-color: #FFFFFF; color:#000000 }");
        println("pre,code { font-family: Lucida Console, Courier; font-size: 9pt; color: #202020; }");
        println("");
        ...
        println(".FrameTitleFont   { font-size: 100%; font-family: "+fontFamily+"; color:#000000 }");
        println(".FrameHeadingFont { font-size:  90%; font-family: "+fontFamily+"; color:#000000 }");
        println(".FrameItemFont    { font-size:  90%; font-family: "+fontFamily+"; color:#000000 }");
        println("");
       ...
       // Removed doclet.Style_line_9 as no longer needed
        ...
        print(".NavBarFont1    { font-family: "+fontFamily+"; color:#000000;");
        println("color:#000000;}");
        print(".NavBarFont1Rev { font-family: "+fontFamily+"; color:#FFFFFF;");
        println("color:#FFFFFF;}");
        println("");

        print(".NavBarCell2    { font-family: "+fontFamily+"; ");
        println("background-color:#FFFFFF; color:#000000}");
        print(".NavBarCell3    { font-family: "+fontFamily+"; ");
        println("background-color:#FFFFFF; color:#000000}");
        println("");
