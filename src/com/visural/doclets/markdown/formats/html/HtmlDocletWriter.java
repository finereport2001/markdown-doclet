...
import com.visural.doclets.markdown.formats.html.markup.*;

import com.visural.doclets.markdown.internal.toolkit.*;
import com.visural.doclets.markdown.internal.toolkit.util.*;
import com.visural.doclets.markdown.internal.toolkit.taglets.*;
...
public class HtmlDocletWriter extends HtmlDocWriter {
    ...
    private MarkdownProcessor mp = new MarkdownProcessor();
        ...
        for (int i = 0; i < tags.length; i++) {
            ...
            if (tagelem instanceof SeeTag) {
                ...
                while (lines.hasMoreTokens()) {
                    ...
                    // trim off leading space so that text is more representative
                    // of real text.
                    if (line.charAt(0) == ' ') {
                        line.deleteCharAt(0);
                    }
